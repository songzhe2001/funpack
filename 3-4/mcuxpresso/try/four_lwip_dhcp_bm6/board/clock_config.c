...
- {id: SCG.PLL1M_MULT.scale, value: '16'}
- {id: SCG.PLL1_PDIV.scale, value: '2', locked: true}
...
- {id: SYSCON.CTIMERCLKSEL0.sel, value: SCG.FRO_12M}
- {id: SYSCON.FLEXSPICLKSEL.sel, value: NO_CLOCK}
- {id: SYSCON.FREQMEREFCLKSEL.sel, value: SYSCON.evtg_out0a}
- {id: SYSCON.FREQMETARGETCLKSEL.sel, value: SYSCON.evtg_out0a}
- {id: SYSCON.I3C1FCLKDIV.scale, value: '6'}
- {id: SYSCON.I3C1FCLKSEL.sel, value: SCG.PLL0_CLK}
- {id: SYSCON.TSICLKSEL.sel, value: SCG.CLK_IN}
- {id: TSICLKDIV, value: Enable}
sources:
...
void BOARD_BootClockPLL150M(void)
{
    ...
    SCG0->SOSCCSR |= SCG_SOSCCSR_SOSCSTEN_MASK;      /* Enables the SOSC clock source in Deep Sleep mode */
    ...
    SYSCON->CLOCK_CTRL |=  SYSCON_CLOCK_CTRL_CLKIN_ENA_MASK;                 /*!< Enable CLKIN_ENA*/
    CLOCK_AttachClk(kCLK_IN_to_TSI);                 /*!< Switch TSI to CLK_IN */
    ...
    CLOCK_SetClkDiv(kCLOCK_DivTsiClk, 1U);           /*!< Set TSICLKDIV divider to value 1 */
