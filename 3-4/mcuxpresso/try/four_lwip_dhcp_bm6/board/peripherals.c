...
- name: BOARD_InitPeripherals
  UUID: fa294220-76d4-48cc-b5fb-f5d00b46cf02
...
- config_sets:
  - fsl_ctimer:
    ...
    - interruptCallbackConfig:
      ...
      - match0Callback: 'tim1_match0_IRQ'
      - match1Callback: ''
      - match2Callback: ''
      - match3Callback: ''
      - capture0Callback: ''
...
ctimer_callback_t CTIMER0_callback[] = {tim1_match0_IRQ, NULL, NULL, NULL, NULL, NULL, NULL, NULL};
