...
- pin_list:
  ...
  - {pin_num: F4, peripheral: I3C1, signal: SCL, pin_signal: PIO1_17/FC5_P1/FC3_P5/CT_INP13/SCT0_OUT7/FLEXIO0_D25/PLU_OUT5/ENET0_RXD3/I3C1_SCL/ADC1_A17, pull_select: up,
    pull_enable: enable}
  ...
  - {pin_num: F1, peripheral: SCG0, signal: XTAL, pin_signal: PIO1_30/TRIG_OUT3/CT_INP16/SCT0_OUT8/SAI0_MCLK/XTAL48M}
  - {pin_num: F2, peripheral: SCG0, signal: EXTAL, pin_signal: PIO1_31/TRIG_IN4/CT_INP17/SCT0_OUT9/EXTAL48M}
...
void BOARD_InitPins(void)
{
    ...
    /* PORT1_30 (pin F1) is configured as XTAL48M */
    PORT_SetPinMux(PORT1, 30U, kPORT_MuxAlt0);
    ...
    /* PORT1_31 (pin F2) is configured as EXTAL48M */
    PORT_SetPinMux(PORT1, 31U, kPORT_MuxAlt0);
